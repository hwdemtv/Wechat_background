      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body" pad15>
            <form action="/Zhis/Link/update" method="POST" enctype="multipart/form-data">
			...
			<div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" name="content" autocomplete="off" class="layui-input" value="<?php echo ($mod["content"]); ?>">
                </div>
              </div>
              <div class="layui-form-item">
