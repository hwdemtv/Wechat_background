    ...
    <div class="layui-col-md12">
      <div class="layui-card">
        <div class="layui-card-body">
          ...
          <a class="layui-btn layuiadmin-btn-admin" href="/Zhis/Link/add">添加</a>
        </div>
				 ...
				 <?php if(is_array($mod)): $i = 0; $__LIST__ = $mod;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody>
                    <tr>
						...
						<td>
						 ...
						 <?php if($vo["status"] == 1 ): ?><td class=""><a href="/Zhis/Link/guan?id=<?php echo ($vo["id"]); ?>">
						<button class="layui-btn">显示</button> </a>
						
						</td>
						<?php else: ?>
						<td class=""><a href="/Zhis/Link/tans?id=<?php echo ($vo["id"]); ?>">
                        ...
                        <td class="td-manage">
                            ...
                            <a title="编辑" href="/Zhis/Link/edit?id=<?php echo ($vo["id"]); ?>" 
                            class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>编辑
                            </a>
                            
                            <a title="删除" href="/Zhis/Link/del?id=<?php echo ($vo["id"]); ?>" 
