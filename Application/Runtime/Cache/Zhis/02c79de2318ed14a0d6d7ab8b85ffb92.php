      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body" pad15>
            <form action="/Zhis/Type/update" method="POST" enctype="multipart/form-data">
			...
			<div class="layui-form-item">
					...
					<div class="layui-input-block">
					   <?php if($mod["picname"] == ''): ?><input type="file" name="picname"/><?php else: ?><img src="<?php echo ($mod["picname"]); ?>" width="200" height="200"/><a href="javascript:void(0)" class="editpic">更换</a><?php endif; ?><span id="file"></span>
					</div>
				</div>
